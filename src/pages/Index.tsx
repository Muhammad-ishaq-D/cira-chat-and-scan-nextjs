      ...
      <SEO
        ...
        jsonLd={[
          ...
          },
          {
            ...
            "@id": "https://askainurse.com/#softwareapplication",
            name: "Cira AI Nurse",
            url: "https://askainurse.com/",
            ...
            featureList: [
              "AI symptom checker with instant health guidance",
              "30-second camera-based vital signs scan",
              "Unlimited AI nurse chat consultation",
              "Predictive health risk markers and wellness score",
              "Prescription refill assistance",
              "100% on-device processing for privacy",
            ],
            screenshot: {
              "@type": "ImageObject",
              url: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/79f99a8b-3f4e-4ecf-a1d4-22d65314359f/id-preview-e35fc074--394ea854-8adf-4e5d-9a7c-bdae5eafddc9.lovable.app-1774687898031.png",
              caption: "Cira AI Nurse dashboard showing vital signs and chat interface",
            },
            aggregateRating: {
