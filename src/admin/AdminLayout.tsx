...
const navItems = [
  { icon: BarChart3, label: "Overview", id: "overview", path: "/admin/dashboard" },
  { icon: Users, label: "Users", id: "users", path: "/admin/users" },
  { icon: Activity, label: "Activity", id: "activity", path: "/admin/activity" },
...
const AdminLayout = () => {
  ...
  return (
    <div className="flex bg-background" style={{ height: "100dvh" }}>
      {/* Slim icon sidebar — same style as user dashboard */}
      <div className="hidden md:flex w-[72px] border-r border-border bg-card flex-col items-center py-4 shrink-0">
        ...
        <div className="flex items-center gap-1 mb-4">
          ...
          <span className="text-[8px] font-semibold text-primary uppercase tracking-wider">Admin</span>
        </div>
      ...
      <div className="flex-1 overflow-y-auto relative">
        {/* Gradient background — same as user dashboard */}
