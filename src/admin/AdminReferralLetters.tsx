...
import { RefreshCw, Search, AlertTriangle, Inbox, FileText, Clock, Stethoscope, Copy, CheckCheck } from "lucide-react";
import { adminApi, type ReferralLetter } from "@/lib/apiClient";
