...
const Skeleton = () => (
  <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pb-28 md:pb-8 space-y-4 sm:space-y-6 animate-pulse">
...
const AdminOverview = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pb-28 md:pb-8 space-y-4 sm:space-y-6">
