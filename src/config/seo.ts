...
import { SITE_URL as _SITE_URL, OG_IMAGE as _OG_IMAGE, sitewideJsonLd as _sitewideJsonLd, seoConfig as _seoConfig } from "./seo.data.mjs";
...
export const sitewideJsonLd: Record<string, any>[] = _sitewideJsonLd;
