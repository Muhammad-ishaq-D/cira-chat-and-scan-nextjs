...
export interface ShenaiSDK extends ShenaiSDKEnums {
  ...
  getLastCameraError: () => CameraError | null
  ...
  setBlockingMeasurementConditions: (conditions: MeasurementEnvironmentCondition[]) => void
  getBlockingMeasurementConditions: () => MeasurementEnvironmentCondition[]
  setWarningMeasurementConditions: (conditions: MeasurementEnvironmentCondition[]) => void
  getWarningMeasurementConditions: () => MeasurementEnvironmentCondition[]
  getCurrentViolatedMeasurementEnvironmentCondition: () => MeasurementEnvironmentCondition | null
  ...
  // Email sending
  sendMeasurementResultsPdfToEmail: (email: string, callback: (success: boolean) => void) => void
  openMeasurementResultsPdfInBrowser: () => void
  getMeasurementResultsPdfUrl: (callback: (url: string) => void) => void
  getMeasurementResultsPdfBytes: (callback: (bytes: Uint8Array) => void) => void
  getResultAsFhirObservation: () => string | null
  sendResultFhirObservation: (url: string, callback?: (response: string) => void) => void
}

export function createPreloadDisplay(canvasId: string, options?: { hideLogo?: boolean }): void
